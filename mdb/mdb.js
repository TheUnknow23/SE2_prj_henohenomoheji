...
exams.add({"id": users[0].id, "email": users[0].email}, "cool title", "cool subject", "description", [{"id":tasks[0].id, "text": tasks[0].description}, {"id":tasks[2].id, "text": tasks[2].description}], groups[0], new Date("2018-12-01"), new Date("2018-12-03"));
