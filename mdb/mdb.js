...
exams.add({"id": users[0].id, "email": users[0].email}, "cool title1", "description0", [{"id":tasks[0].id, "text": tasks[0].description}], groups[1], new Date("2018-12-31"), new Date("2017-01-03"));
