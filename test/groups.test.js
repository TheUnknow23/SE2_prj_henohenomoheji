...
test('call updateGroup wrong id, correct payload', ()=>{
    expect(groups.updateGroup(689, {"name":"hgh", "description": "hfjvbj"})).toBe('The specified id does not exist');
});
test('call updateGroup wrong owner, correct payload and id', ()=>{
    expect(groups.updateGroup(0, {"name":"hgh", "description": "hfjvbj"})).toBe(403);
});
test('call updateGroup non-existing user, correct payload and id', ()=>{
    expect(groups.updateGroup(0, {"name":"hgh", "description": "hfjvbj"})).toBe(401);
});